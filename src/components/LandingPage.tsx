		...
		<div className="relative min-h-screen bg-[#f9eddc] overflow-hidden">
			<section className="relative h-screen rounded-bl-[50px] rounded-br-[50px] overflow-hidden">
				...
				<header className="relative z-10 flex items-center justify-between px-6 py-5">
					...
					<button
						type="button"
						className="bg-[#f9a058]/50 hover:bg-[#f9a058]/60 transition-all duration-300 px-7 py-4 rounded-full shadow-lg text-white font-semibold text-base tracking-tight"
					>
						Get Started
					</button>
				</header>
...
function PathCard({ pathNumber, title }: PathCardProps) {
	return (
		<article className="glass-card bg-white/10 backdrop-blur-sm rounded-[50px] border border-white/30 p-8 lg:p-12 flex flex-col justify-between min-h-[415px] hover:backdrop-blur-md transition-all duration-500 shadow-[0_8px_32px_rgba(0,0,0,0.1),inset_0_1px_0_rgba(255,255,255,0.5),inset_0_-1px_0_rgba(255,255,255,0.1),inset_0_0_22px_11px_rgba(255,255,255,0.1)]">
